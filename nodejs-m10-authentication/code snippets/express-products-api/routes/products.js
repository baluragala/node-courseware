...
let isAuthenticated = require('./users').isAuthenticated();
...
router.get('/PP*M', isAuthenticated, function (req, res, next) { // APPLICATION MIDDLEWARE
  res.json(products.concat(premiumProductsMobiles));
});

router.get('/PP*C', isAuthenticated, function (req, res, next) { // APPLICATION MIDDLEWARE
